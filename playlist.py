...
def read_videos():
	videos = []
	total_video = int(input("Enter how many vids: "))
...
def show_menu():
	print("Main Menu:")
	print("-----------------------------")
	print("| Option 1: Dreate playlist |")
...
def add_video(playlist):
	...
	new_video_title = input("Enter a new video title: ") + "\n"
	new_video_link = input("Enter a new video link: ") + "\n"
...
def update_playlist(playlist):
	...
	choice = select_in_range("Enter what you update (1 - 3):", 1, 3)
	if choice == 1:
		new_playlist_name = input("Enter name for playlist: ") +  "\n"
